...
function doGet(e) {
  ...
  var ret_columnHeaders = common.get_columnHeaders(columnHeaders)
  var ret_userData = common.get_userData(email, user, columnHeaders)
